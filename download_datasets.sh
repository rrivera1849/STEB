...
# bible_versions: Carlson, Riddell & Rockmore 2018 StyleTransferBibleData
# (Royal Society Open Science 5: 171920). 8 verse-aligned public-domain
# English Bible translations (KJV, ASV, YLT, DARBY, DRA, BBE, WEB, LEB).
# Only Data/Bibles/ is needed; the rest of the repo (training splits, model
# code, results) is skipped via sparse-checkout.
